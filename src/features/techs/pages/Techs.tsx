...
// hooks
import { useEditAction, useRestoreDialog, useDeleteDialog } from "hooks";
import { TechsQueryKeys, useTechsList } from "../hooks";
import { useTechTypesCommon } from "features/techTypes";

// sitemap
import { PageId } from "../../../app/sitemap";
    ...
    [
      nameColumn<TechDto>(),
      {
        ...
        renderBody: (_: unknown, tech: TechDto) => (
          <Link
            className={`underline ${tech.deletedAt ? "text-fg-muted" : "text-primary"}`}
