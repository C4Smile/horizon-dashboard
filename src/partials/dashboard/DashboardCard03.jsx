...
function DashboardCard03() {
  const chartData = {
    ...
    datasets: [
      ...
      {
        data: [
          540, 466, 540, 466, 385, 432, 334, 334, 289, 289, 200, 289, 222, 289, 289, 403, 554, 304, 289,
          270, 134, 270, 829, 344, 388, 364,
        ],
        fill: true,
      ...
      {
        data: [
          689, 562, 477, 477, 477, 477, 458, 314, 430, 378, 430, 498, 642, 350, 145, 145, 354, 260, 188,
          188, 300, 300, 282, 364, 660, 554,
        ],
      ...
      <div className="px-5 pt-5">
        <header className="flex justify-between items-start mb-2">
          ...
          <EditMenu align="right" className="relative inline-flex">
            <li>
              <Link
                className="font-medium text-sm text-slate-600 dark:text-slate-300 hover:text-slate-800  flex py-1 px-3"
                to="#0"
              >
                Option 1
              </Link>
