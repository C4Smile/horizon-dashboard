...
export const pageId = {
  ...
  recovery: "recuperar",
  updatePassword: "actualizarContrasena",
  dashboard: "panelAdministrativo",
  home: "inicio",
  settings: "ajusts",
  // devices
  ...
  // museum
  services: "servicios",
  servicesNew: "serviciosNuevo",
  servicesEdit: "serviciosEditar",
  rooms: "salas",
  roomsNew: "salasNueva",
  roomsEdit: "salasEditar",
  sortRooms: "ordernarSalas",
  roomAreas: "areaDeSalas",
  roomAreasNew: "areaDeSalasNueva",
  roomAreasEdit: "areaDeSalasEditar",
  ...
  activitiesEdit: "actividadesEditar",
  news: "noticias",
  newsNew: "noticiasNueva",
  newsEdit: "noticiasEditar",
  events: "eventos",
  eventsNew: "eventosNuevo",
  eventsEdit: "eventosEditar",
  tags: "etiquetas",
  tagsNew: "etiquetasNueva",
  tagsEdit: "etiquetasEditar",
  // management
  chatBot: "chatBot",
  pushNotifications: "pushNotifications",
  pushNotificationsNew: "pushNotificationsNew",
  pushNotificationsEdit: "pushNotificationsEdit",
  appTexts: "traducciones",
  appTextsNew: "traduccionesNueva",
  appTextsEdit: "traduccionesEditar",
  // personal
  users: "usuarios",
  usersNew: "usuariosNuevo",
  usersEdit: "usuariosEditar",
};
